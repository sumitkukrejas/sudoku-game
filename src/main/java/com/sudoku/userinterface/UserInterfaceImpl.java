...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private static final Color WINDOW_BACKGROUND_COLOR = Color.rgb(1, 150, 136);
    ...
    private void styleSudokuTitle(SudokuTextField tile, double x,double  y) {
